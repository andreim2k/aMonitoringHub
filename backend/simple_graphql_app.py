"""
Simple GraphQL + SSE Flask application for aTemperature monitoring system.
...
# Temperature Collector (same as before)
    ...
    def collect_temperature(self):
        try:
            ...
            if db_reading:
                ...
                self.logger.debug(f"Collected temperature: {reading.temperature_c:.2f}°C")
...
def events():
    def event_stream():
        while True:
            try:
                data = sse_clients.get(timeout=30)
