...
def run_ocr() -> Response:
    ...
    try:
        ...
        try:
            ...
            logger.info("Using OCR engine: Google Gemini API (2.5 Pro)")
            if not api_key:
            ...
            if 'error' in result:
                ...
                return jsonify({
                    "success": False,
                    "engine": "Google Gemini API (2.5 Pro)",
            ...
            if four_digit:
                ...
                try:
                    db.add_meter_reading(
                        ...
                        ocr_engine="Google Gemini API (2.5 Pro)",
            ...
            return jsonify({
                ...
                "engine": "Google Gemini API (2.5 Pro) - Error",
                "image": cap_json['image'],
                "timestamp": datetime.now().isoformat() + "Z"
            })
    except Exception as e:
