...
def run_ocr() -> Response:
    ...
    try:
        ...
        try:
            ...
            logger.info("Using OCR engine: Google Gemini API (3.1 Flash)")
            if not api_key:
            ...
            gemini_url = f"https://generativelanguage.googleapis.com/v1beta/models/gemini-3.1-flash:generateContent?key={api_key}"
            ...
            if 'error' in result:
                ...
                return jsonify({
                    "success": False,
                    "engine": "Google Gemini API (3.1 Flash)",
            ...
            if four_digit:
                ...
                try:
                    db.add_meter_reading(
                        ...
                        ocr_engine="Google Gemini API (3.1 Flash)",
            ...
            return jsonify({
                ...
                "engine": "Google Gemini API (3.1 Flash) - Error",
                "image": cap_json['image'],
                "timestamp": datetime.now().isoformat() + "Z"
            })
    except Exception as e:
